...
public class FacebookCheckBoxTest {
    ...
    static void initializeFields() {
        System.out.println("\nRunning " + FacebookCheckBoxTest.class.getSimpleName() + "...");
    ...
    @Test
    @Order(3)
    @DisplayName("Hovering over the facebook checkbox")
    void hoverOverCheckBox() {
        // Act
        try {
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("eu-cookie-compliance-banner")));
            element = wait.
                    until(ExpectedConditions.elementToBeClickable(By.id("cookie-category-facebook")));
            System.out.println("Hovering over the facebook checkbox...");
    ...
    @Test
    @Order(4)
    @DisplayName("Clicking the facebook checkbox")
    void clickTheCheckBox() {
        // Act
        try {
            System.out.println("Clicking the facebook checkbox...");
