...
public class PerformanceCheckBoxTest {
    ...
    static void initializeFields() {
        System.out.println("\nRunning " + PerformanceCheckBoxTest.class.getSimpleName() + "...");
    ...
    @Test
    @Order(3)
    @DisplayName("Hovering over the performance checkbox")
    void hoverOverCheckBox() {
        // Act
        try {
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("eu-cookie-compliance-banner")));
            element = wait.
                    until(ExpectedConditions.elementToBeClickable(By.id("cookie-category-performance")));
            System.out.println("Hovering over the performance checkbox...");
    ...
    @Test
    @Order(4)
    @DisplayName("Clicking the performance checkbox")
    void clickTheCheckBox() {
        // Act
        try {
            System.out.println("Clicking the performance checkbox...");
