...
public class AcceptAllCookiesTest {
    ...
    static void initializeFields() {
        System.out.println("\nRunning " + AcceptAllCookiesTest.class.getSimpleName() + "...");
    ...
    @Test
    @Order(3)
    @DisplayName("Hovering over the 'Accept All Cookies' button")
    void hoverOverCheckBox() {
        // Act
        try {
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("eu-cookie-compliance-banner")));
            element = wait.
                    until(ExpectedConditions.elementToBeClickable(By.className("agree-button")));
            System.out.println("Hovering over the 'Accept All Cookies' button...");
    ...
    @Test
    @Order(4)
    @DisplayName("Clicking the 'Accept All Cookies' button")
    void clickTheCheckBox() {
        // Act
        try {
            System.out.println("Clicking the 'Accept All Cookies' button...");
